...
export function SkillForm({ skill, mode = "create" }) {
    ...
    return (
        <section className="max-w-5xl mx-auto w-full space-y-12 animate-in fade-in slide-in-from-bottom-10 duration-1000" aria-label="Skill Registration Form">
            ...
            <article className="bg-white border-2 border-slate-50 rounded-[3rem] shadow-mega overflow-hidden relative">
                <header className="bg-slate-950 px-16 py-16 text-white relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div className="space-y-10">
                            <div className="space-y-4">
                                <Label htmlFor="name" className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Skill Name</Label>
                                <Input
                                    id="name"
                                    {...register("name")}
                                ...
                                />
                                {errors.name && <p id="name-error" role="alert" aria-live="polite" className="text-[9px] font-black text-rose-500 uppercase tracking-widest ml-1">{errors.name.message}</p>}
                            </div>

                            <div className="space-y-4">
                                <Label htmlFor="category" className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Assigned Department</Label>
                                <Select value={selectedCategory} onValueChange={(val) => setValue("category", val)}>
                                    <SelectTrigger id="category" aria-label="Select department category for this skill" className="h-16 bg-slate-50/50 border-2 border-slate-50 rounded-[1.5rem] text-sm font-bold tracking-tight uppercase focus:bg-white focus:border-primary/20 transition-all">
                        ...
                        <div className="space-y-10">
                            <div className="space-y-4">
                                <Label id="skill-classification-label" className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Skill Classification</Label>
                                <div role="radiogroup" aria-labelledby="skill-classification-label" className="grid grid-cols-2 gap-3">
                                    {[
                            ...
                            <div className="space-y-4">
                                <Label id="verification-status-label" className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Verification Status</Label>
                                <div role="radiogroup" aria-labelledby="verification-status-label" className="grid grid-cols-3 gap-3">
                                    {[
                            ...
                            <div className="bg-slate-50/50 p-10 rounded-[2.5rem] border-2 border-slate-50 space-y-8">
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    <div className="space-y-4">
                                        <Label htmlFor="auto_eval" className="text-[9px] font-black text-slate-400 uppercase">Self-Eval</Label>
                                        <Input
                                            id="auto_eval"
                                            type="number"
                                    ...
                                    <div className="space-y-4">
                                        <Label htmlFor="hierarchie_eval" className="text-[9px] font-black text-slate-400 uppercase">Manager</Label>
                                        <Input
                                            id="hierarchie_eval"
                                            type="number"
