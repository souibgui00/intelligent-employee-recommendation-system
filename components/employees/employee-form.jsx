...
export function EmployeeForm({ employee, mode = "create" }) {
  ...
  return (
    <section className="max-w-4xl mx-auto w-full space-y-12 animate-in fade-in slide-in-from-bottom-5 duration-700" aria-label="Employee Form">
      ...
      <article className="bg-white border border-slate-100 rounded-[48px] shadow-mega overflow-hidden relative">
        {/* Decorative Header */}
        <header className="bg-slate-950 px-12 py-12 text-white relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-12 space-y-12 relative z-10 bg-white">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-[10px] font-black text-slate-900 uppercase tracking-[0.4em]">Core Details</h2>
              <div className="h-px flex-1 bg-slate-100"></div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                <Label htmlFor="name" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Full Name</Label>
                <Input id="name" aria-required="true" aria-describedby={errors.name ? "name-error" : undefined} {...register("name")} placeholder="John Doe"
                ...
                />
                {errors.name && <p id="name-error" role="alert" aria-live="polite" className="text-[9px] font-bold text-rose-500 mt-1">{errors.name.message}</p>}
              </div>

              <div className="space-y-3">
                <Label htmlFor="email" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Email Address</Label>
                <Input id="email" aria-required="true" aria-describedby={errors.email ? "email-error" : undefined} {...register("email")} type="email" placeholder="email@company.com"
                ...
                />
                {errors.email && <p id="email-error" role="alert" aria-live="polite" className="text-[9px] font-bold text-rose-500 mt-1">{errors.email.message}</p>}
              </div>

              <div className="space-y-3">
                <Label htmlFor="telephone" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Phone Number</Label>
                <Input id="telephone" aria-describedby={errors.telephone ? "tel-error" : undefined} {...register("telephone")} type="tel" placeholder="+1 234 567 890"
                ...
                />
                {errors.telephone && <p id="tel-error" role="alert" aria-live="polite" className="text-[9px] font-bold text-rose-500 mt-1">{errors.telephone.message}</p>}
              </div>

              {mode === "edit" && (
                <div className="space-y-3">
                  <Label htmlFor="matricule" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Registration Number (Matricule)</Label>
                  <Input id="matricule" {...register("matricule")} placeholder="EMP-1024"
                    readOnly={true}
                    aria-describedby={errors.matricule ? "mat-error" : undefined}
                  ...
                  />
                  {errors.matricule && <p id="mat-error" role="alert" aria-live="polite" className="text-[9px] font-bold text-rose-500 mt-1">{errors.matricule.message}</p>}
                </div>
              )}
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-[10px] font-black text-slate-900 uppercase tracking-[0.4em]">Work Details</h2>
              <div className="h-px flex-1 bg-slate-100"></div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                <Label htmlFor="department_id" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Department</Label>
                <Select value={departmentId} onValueChange={(v) => setValue("department_id", v)}>
                  <SelectTrigger id="department_id" aria-label="Select department" className={cn("h-14 bg-slate-50/50 border-slate-100 rounded-2xl text-[11px] font-black tracking-widest uppercase", errors.department_id && "border-rose-300")}>
                ...
                {errors.department_id && <p role="alert" aria-live="polite" className="text-[9px] font-bold text-rose-500 mt-1">{errors.department_id.message}</p>}
              </div>



              <div className="space-y-3">
                <Label htmlFor="position" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Position Title</Label>
              ...
              <div className="space-y-3">
                <Label htmlFor="role" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Access Role</Label>
                <Select value={role} onValueChange={(v) => setValue("role", v)}>
                  <SelectTrigger id="role" aria-label="Select role" className={cn("h-14 bg-slate-50/50 border-slate-100 rounded-2xl text-[11px] font-black tracking-widest uppercase", errors.role && "border-rose-300")}>
                ...
                {errors.role && <p role="alert" aria-live="polite" className="text-[9px] font-bold text-rose-500 mt-1">{errors.role.message}</p>}
              </div>

              <div className="space-y-3">
                <Label htmlFor="date_embauche" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Hiring Date</Label>
                <Input id="date_embauche" {...register("date_embauche")} type="date"
                  className="h-14 bg-slate-50/50 border-slate-100 rounded-2xl text-[11px] font-black tracking-widest uppercase focus:bg-white focus:ring-primary/10 transition-all"
                />
              </div>

              <div className="space-y-3">
                <Label htmlFor="status" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Account Status</Label>
                <Select value={status} onValueChange={(v) => setValue("status", v)}>
                  <SelectTrigger id="status" aria-label="Select account status" className={cn("h-14 bg-slate-50/50 border-slate-100 rounded-2xl text-[11px] font-black tracking-widest uppercase", errors.status && "border-rose-300")}>
            ...
            <div className="space-y-3">
              <Label htmlFor="jobDescription" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Job Description</Label>
              <Textarea id="jobDescription" {...register("jobDescription")} placeholder="Describe roles and duties..."
