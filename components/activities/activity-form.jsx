...
export function ActivityForm({ activity, mode = "create" }) {
  ...
  return (
    <section className="max-w-4xl mx-auto w-full space-y-12 animate-in fade-in slide-in-from-bottom-5 duration-700" aria-label="Activity Form Configuration">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-12 space-y-12 bg-white relative z-10">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              <Label htmlFor="title" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Title</Label>
              <Input
                id="title"
                {...register("title")}
              ...
              />
              {errors.title && <p id="title-error" role="alert" aria-live="polite" className="text-[9px] font-bold text-rose-500 mt-1">{errors.title.message}</p>}
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                <Label htmlFor="activity-type" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Type</Label>
                <Select value={formType} onValueChange={(v) => setValue("type", v)}>
                  <SelectTrigger id="activity-type" aria-label="Select activity type" className={cn("h-14 bg-slate-50/50 border-slate-100 rounded-2xl text-[11px] font-black tracking-widest uppercase", errors.type && "border-rose-300")}>
              ...
              <div className="space-y-3">
                <Label htmlFor="activity-status" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Status</Label>
                <Select value={formStatus} onValueChange={(v) => setValue("status", v)}>
                  <SelectTrigger id="activity-status" aria-label="Select activity status" className="h-14 bg-slate-50/50 border-slate-100 rounded-2xl text-[11px] font-black tracking-widest uppercase">
            ...
            <div className="space-y-3">
              <Label htmlFor="description" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Description</Label>
              <Textarea
                id="description"
              ...
              />
              {errors.description && <p id="desc-error" role="alert" aria-live="polite" className="text-[9px] font-bold text-rose-500 mt-1">{errors.description.message}</p>}
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-[10px] font-black text-slate-900 uppercase tracking-[0.4em]">Logistics</h2>
              <div className="h-px flex-1 bg-slate-100"></div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="space-y-3 lg:col-span-1 md:col-span-2">
                <Label htmlFor="date" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Date</Label>
                <Input
                  id="date"
                  {...register("date")}
                  type="date"
                ...
                />
                {errors.date && <p id="date-error" role="alert" aria-live="polite" className="text-[9px] font-bold text-rose-500 mt-1">{errors.date.message}</p>}
              </div>
              <div className="space-y-3">
                <Label htmlFor="duration" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Duration</Label>
                <Input
                  id="duration"
                  {...register("duration")}
                ...
                />
                {errors.duration && <p id="duration-error" role="alert" aria-live="polite" className="text-[9px] font-bold text-rose-500 mt-1">{errors.duration.message}</p>}
              </div>
              <div className="space-y-3">
                <Label htmlFor="capacity" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Capacity</Label>
                <Input
                  id="capacity"
                  {...register("capacity")}
                  type="number"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                <Label htmlFor="location" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Location</Label>
                <Input
                  id="location"
                  {...register("location")}
                ...
                />
                {errors.location && <p id="location-error" role="alert" aria-live="polite" className="text-[9px] font-bold text-rose-500 mt-1">{errors.location.message}</p>}
              </div>

              <div className="space-y-3">
                <Label htmlFor="level" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Level</Label>
                <Select value={formLevel} onValueChange={(v) => setValue("level", v)}>
                  <SelectTrigger id="level" aria-label="Select level" className="h-14 w-full bg-slate-50/50 border-slate-100 rounded-2xl text-[11px] font-black tracking-widest uppercase">
              ...
              <div className="space-y-3">
                <Label htmlFor="intent" className="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-1 font-mono">Recommendation Intent</Label>
                <Select value={formIntent} onValueChange={(v) => setValue("intent", v)}>
                  <SelectTrigger id="intent" aria-label="Select recommendation intent" className="h-14 w-full bg-slate-50/50 border-slate-100 rounded-2xl text-[11px] font-black tracking-widest uppercase">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-[10px] font-black text-slate-900 uppercase tracking-[0.4em]">Target Departments</h2>
              <div className="h-px flex-1 bg-slate-100"></div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-[10px] font-black text-slate-900 uppercase tracking-[0.4em]">Skills Covered</h2>
              <div className="h-px flex-1 bg-slate-100"></div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                {customSkillMode ? (
                  ...
                  <>
                    <Label htmlFor="skill-add" className="sr-only">Add Skill</Label>
                    <Select
                      value={addSkillValue}
                      onValueChange={(v) => {
                        if (v === "##AUTRE##") {
                    ...
                    >
                      <SelectTrigger id="skill-add" aria-label="Select skill to add" className="h-14 flex-1 bg-slate-50/50 border-slate-100 rounded-2xl text-[11px] font-black tracking-widest uppercase md:max-w-md">
