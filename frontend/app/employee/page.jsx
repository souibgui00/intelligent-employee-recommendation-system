...
export default function EmployeeHome() {
  ...
  const topRecommendation = useMemo(() => {
    ...
    const enrolledIds = participations?.map(p => typeof p.activityId === 'object' ? p.activityId?._id : p.activityId).filter(Boolean) || []
    return activities.find(a => a && !enrolledIds.includes(a.id) && !enrolledIds.includes(a._id))
