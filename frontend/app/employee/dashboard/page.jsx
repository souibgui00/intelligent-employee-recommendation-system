...
export default function EmployeeDashboard() {
  ...
  return (
    <div className="p-5 md:p-6 space-y-8 max-w-400 mx-auto animate-in fade-in duration-700 bg-transparent text-[#2C2C2C]">
      {/* Hero Welcome Section */}
      <div className="relative overflow-hidden rounded-4xl bg-[#2C2C2C] border border-white/5 p-6 lg:p-8 shadow-2xl">
