...
export default function EmployeeRecommendationsPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-transparent page-transition overflow-x-hidden pb-20">
      {/* Premium AI Navigator Header */}
      <div className="mesh-gradient-premium pt-26 pb-36 px-5 md:px-6 relative overflow-hidden">
