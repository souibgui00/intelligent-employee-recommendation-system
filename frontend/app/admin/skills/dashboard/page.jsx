...
export default function AdminGlobalSkillsDashboard() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen text-slate-400 space-y-4">
        <Sparkles className="w-16 h-16 animate-pulse opacity-20 text-[#F28C1B]" />
  ...
  return (
    <div className="flex flex-col bg-[#F8FAFC] min-h-screen pb-20">
      ...
      <div className="flex-1 p-8 max-w-[1400px] mx-auto w-full space-y-8 animate-in fade-in duration-700">
        
        {/* Header Setup */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <h1 className="text-3xl font-black text-slate-900 tracking-tight">Competency Dashboard<span className="text-[#F28C1B]">.</span></h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2 p-8 border-none shadow-sm rounded-3xl bg-white relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#F28C1B]/5 rounded-full blur-3xl -mr-32 -mt-32"></div>
            <div className="relative z-10 flex flex-col h-full">
              <div className="flex items-center justify-between mb-8">
                <div>
                  <h3 className="text-lg font-black text-slate-900 tracking-tight flex items-center gap-3">
                    <BarChart3 className="w-5 h-5 text-[#F28C1B]" />
