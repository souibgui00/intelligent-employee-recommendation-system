...
export default function ManagerSkillsPage() {
    ...
    return (
        <section className="flex flex-col bg-[#F8FAFC] min-h-screen" aria-label="Manager skills">
            ...
            <div className="flex-1 p-8 space-y-10 animate-in fade-in duration-500">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* Skill Deficits */}
                    <article className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden flex flex-col" aria-label="Skill gaps">
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        {/* Top Strengths */}
                        <article className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden flex-1" aria-label="Top team strengths">
                            <div className="p-6 border-b border-slate-100 bg-slate-50/30">
