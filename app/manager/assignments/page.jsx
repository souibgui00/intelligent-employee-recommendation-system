...
export default function ManagerAssignmentsPage() {
  ...
  return (
    <section className="flex flex-col bg-[#F8FAFC] min-h-screen page-transition" aria-label="Manager Assignments">
          ...
          <div className="space-y-8">
            ...
            <div className="grid gap-10">
              {pendingActivities.map(([activityId, activityAssignments]) => {
                ...
                return (
                  <article key={activityId} className="card-premium p-0 border-none bg-white" aria-label={activity.title}>
                    {/* Activity header */}
          ...
          <div className="space-y-8 pt-8 border-t border-slate-100">
            ...
            <div className="grid gap-6">
              {processedActivities.map(([activityId, activityAssignments]) => {
                ...
                return (
                  <article key={activityId} className="card-premium p-6 flex flex-col md:flex-row items-center justify-between gap-8 opacity-80 group hover:opacity-100" aria-label={activity.title}>
