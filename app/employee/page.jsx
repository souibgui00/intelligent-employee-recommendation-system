...
export default function EmployeeHome() {
  ...
  return (
    <section className="flex flex-col min-h-screen bg-transparent page-transition overflow-x-hidden pb-16 font-sans text-[#2C2C2C]" aria-label="Employee Dashboard">


      {/* Immersive Hero Section with Mesh Gradient */}
      <header className="relative mesh-gradient-premium pt-16 md:pt-24 pb-24 md:pb-36 px-4 md:px-6 overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10">
            <div className="space-y-6 max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <button
                  aria-label="Start Professional Journey"
