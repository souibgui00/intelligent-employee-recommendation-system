...
export default function EmployeeHubPage() {
  ...
  return (
    <section className="min-h-screen bg-[#f0f2f5] pt-20 pb-8 font-sans text-[#1c1e21]" aria-label="Employee hub community feed">
      <div className="max-w-300 mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">

          {/* Left Sidebar (Navigation) */}
          <nav className="hidden lg:block lg:col-span-3 sticky top-20 space-y-1.5" aria-label="Hub navigation">
          ...
          {/* Center Column (Feed) */}
          <article className="col-span-1 lg:col-span-6 space-y-3" aria-label="Feed content">
          ...
          <aside className="hidden lg:block lg:col-span-3 sticky top-20 space-y-3" aria-label="Hub trends and suggestions">
