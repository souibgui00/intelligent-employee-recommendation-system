...
export default function EmployeeActivitiesPage() {
  ...
  return (
    <section className="flex flex-col min-h-screen bg-transparent page-transition overflow-x-hidden" aria-label="Employee activities page">
      {/* Immersive Header */}
      <header className="bg-[#2C2C2C] pt-24 pb-36 px-6 relative overflow-hidden">
...
function ActivityCard({
  ...
  return (
    <article className="group card-premium bg-white border-none shadow-sm flex flex-col font-sans" aria-label={activity.title}>
