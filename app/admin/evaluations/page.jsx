...
export default function EvaluationsPage() {
  ...
  if (viewState.mode === "form") {
    ...
    return (
      <main id="main-content" className="flex flex-col bg-transparent min-h-screen page-transition" aria-label="Evaluation form page">
        <DashboardHeader
        ...
        <section className="flex-1 p-6 md:p-10 max-w-350 mx-auto w-full animate-in fade-in slide-in-from-bottom-6 duration-700 space-y-10" aria-label="Evaluation form content">
          <button
            type="button"
            onClick={() => setViewState({ mode: "list", currentEval: null })}
            aria-label="Return to evaluations overview"
                    ...
                    <div className="space-y-4">
                      ...
                      {isView ? (
                        ...
                        <Select value={employeeId} onValueChange={handleEmployeeChange}>
                          <SelectTrigger aria-label="Select employee" className="h-16 bg-slate-50 border-slate-100 rounded-2xl text-[11px] font-black tracking-widest focus:ring-primary/20 hover:bg-white transition-all">
                    ...
                    <div className="space-y-4">
                      ...
                      {isView ? (
                        ...
                        <Select value={activityId} onValueChange={setActivityId}>
                          <SelectTrigger aria-label="Select activity" className="h-16 bg-slate-50 border-slate-100 rounded-2xl text-[11px] font-black tracking-widest focus:ring-primary/20 hover:bg-white transition-all">
                    ...
                    <div className="space-y-4">
                      ...
                      {isView ? (
                        ...
                        <Select value={evaluationType} onValueChange={setEvaluationType}>
                          <SelectTrigger aria-label="Select evaluation cycle" className="h-16 bg-slate-50 border-slate-100 rounded-2xl text-[11px] font-black tracking-widest focus:ring-primary/20 hover:bg-white transition-all">
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent className="bg-white border-slate-200 rounded-2xl shadow-mega overflow-hidden p-2">
                              ...
                              <div className="text-right flex items-center gap-6">
                                ...
                                {!isView && (
                                  <button
                                    ...
                                    aria-label={`Remove ${skill?.name || "skill"} from evaluation`}
                      ...
                      {!isView && (
                        <div className="pt-4">
                          <Select onValueChange={handleAddSkillToEval}>
                            <SelectTrigger aria-label="Add additional skill to evaluation" className="h-16 bg-white border-2 border-dashed border-slate-200 rounded-2xl text-[10px] font-black tracking-widest text-slate-400 uppercase hover:border-primary hover:text-primary transition-all">
              ...
              <div className="bg-white border border-slate-100 rounded-[48px] shadow-premium p-10 space-y-10">
                <div className="space-y-6">
                  ...
                  {isView ? (
                    ...
                    <>
                      <Label htmlFor="evaluation-feedback" className="text-[10px] font-black text-slate-900 uppercase tracking-[0.2em]">
                ...
                <div className="space-y-6">
                  ...
                  {isView ? (
                    ...
                    <>
                      <Label htmlFor="evaluation-recommendations" className="text-[10px] font-black text-slate-900 uppercase tracking-[0.2em]">
                        Development recommendations
                      </Label>
                      <textarea
                        id="evaluation-recommendations"
  ...
  return (
    <main id="main-content" className="flex flex-col bg-transparent min-h-screen page-transition" aria-label="Evaluations dashboard page">
      <DashboardHeader title="Performance Dashboard" description="Enterprise-scale professional monitoring system" />

      <section className="flex-1 p-6 md:p-10 max-w-350 mx-auto w-full space-y-12 animate-in fade-in duration-700" aria-label="Evaluations dashboard content">

        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-1">
            <h2 className="text-4xl font-black text-slate-900 tracking-tight">Growth <span className="text-primary">.</span></h2>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b border-slate-50 hover:bg-transparent">
                    ...
                    <TableHead className="py-8 text-right px-10">Actions</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                        ...
                        <TableCell className="px-10 py-8 text-right">
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <button type="button" aria-label={`Open actions for evaluation ${evaluation.id || evaluation._id}`} className="h-10 w-10 bg-white border border-slate-100 rounded-xl flex items-center justify-center text-slate-300 hover:text-slate-950 hover:border-slate-300 transition-all shadow-sm active:scale-95">
                            ...
                            <DropdownMenuContent align="end" className="bg-white border-slate-200 rounded-2xl shadow-mega p-2 min-w-50 animate-in fade-in zoom-in-95 duration-200">
                              ...
                              {evaluation.status !== "approved" && (
                                <DropdownMenuItem onClick={() => handleEnterEditMode(evaluation)} className="flex items-center gap-3 rounded-xl px-4 py-3 font-black text-[10px] tracking-widest uppercase text-slate-600 hover:bg-slate-50 hover:text-primary transition-all cursor-pointer">
                                  <Pencil className="w-4 h-4" aria-hidden="true" /> Edit Record
                                </DropdownMenuItem>
                              )}
                              ...
                              >
                                <Trash2 className="w-4 h-4" aria-hidden="true" /> Delete Log
                              </DropdownMenuItem>
                            </DropdownMenuContent>
                          </DropdownMenu>
                        </TableCell>
