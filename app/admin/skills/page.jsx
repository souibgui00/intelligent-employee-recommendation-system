...
export default function AdminSkillsPage() {
  ...
  return (
    <main id="main-content" className="flex flex-col bg-[#F8FAFC] min-h-screen text-slate-600" aria-label="Skills administration page">
      <DashboardHeader title="Skills" description="Manage your skills and training requirements" />

      <section className="flex-1 p-6 md:p-10 max-w-350 mx-auto w-full animate-in fade-in duration-700 space-y-12" aria-label="Skills administration content">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Popover>
                <PopoverTrigger asChild>
                  <Button type="button" variant="outline" aria-label="Open skills filters" className="h-16 px-8 rounded-4xl bg-white border-2 border-slate-50 shadow-premium hover:bg-slate-50 transition-all gap-4">
                  ...
                  <div className="space-y-8">
                    <div className="space-y-3">
                      ...
                      <Select value={filterType} onValueChange={setFilterType}>
                        <SelectTrigger aria-label="Filter by skill category" className="h-14 rounded-2xl border-slate-100 bg-slate-50/50 font-bold text-sm">
                    ...
                    <div className="space-y-3">
                      ...
                      <Select value={filterStatus} onValueChange={setFilterStatus}>
                        <SelectTrigger aria-label="Filter by evaluation status" className="h-14 rounded-2xl border-slate-100 bg-slate-50/50 font-bold text-sm">
              ...
              <Button type="button" onClick={() => navigate("new")} className="h-16 px-10 rounded-4xl bg-slate-950 text-white font-black text-[11px] tracking-widest uppercase hover:bg-primary transition-all shadow-xl active:scale-95 flex items-center gap-4">
          ...
          <div className="lg:col-span-1">
            {selectedSkill ? (
              <div className="bg-white border-2 border-slate-50 rounded-[3rem] p-10 sticky top-8 shadow-2xl shadow-slate-200/50 flex flex-col min-h-162.5 animate-in slide-in-from-right-10 duration-700">
                ...
                <div className="flex bg-slate-100/50 p-1.5 rounded-2xl mb-8" role="tablist" aria-label="Skill detail tabs">
                  {["Overview", "Employees"].map(tab => (
                    <button
                      ...
                      role="tab"
                      aria-selected={activeViewTab === tab}
                      className={cn(
