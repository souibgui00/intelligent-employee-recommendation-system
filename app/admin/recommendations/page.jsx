...
function RecommendationsContent() {
  ...
  return (
    <main id="main-content" className="flex flex-col bg-[#F8FAFC] min-h-screen" aria-label="Admin recommendations page">
      <DashboardHeader title="People Matchmaker" description="AI Help: Finding the right people for every training session." />

      <section className="flex-1 p-8 max-w-7xl mx-auto w-full space-y-8 animate-in fade-in duration-500" aria-label="Recommendations content">
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-baseline gap-2 text-[10px] text-slate-200 font-bold uppercase tracking-widest">
                      <div className="w-1.5 h-1.5 bg-primary rounded-full" aria-hidden="true"></div> Skill Matching
                    </li>
                    <li className="flex items-baseline gap-2 text-[10px] text-slate-200 font-bold uppercase tracking-widest">
                      <div className="w-1.5 h-1.5 bg-primary rounded-full" aria-hidden="true"></div> How fast they learn
                    </li>
                    <li className="flex items-baseline gap-2 text-[10px] text-slate-200 font-bold uppercase tracking-widest">
                      <div className="w-1.5 h-1.5 bg-primary rounded-full" aria-hidden="true"></div> Long-term potential
                    </li>
                  </ul>
                </div>
                <div className="pt-2">
...
export default function AdminRecommendationsPage() {
  return (
    <Suspense fallback={
      <main id="main-content" className="flex items-center justify-center min-h-screen bg-[#F8FAFC]" aria-label="Loading recommendations">
        <section className="flex flex-col items-center gap-6" role="status" aria-live="polite">
          <div className="relative">
            <div className="w-16 h-16 border-4 border-slate-100 border-t-primary rounded-full animate-spin"></div>
            <Cpu className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-6 w-6 text-primary" aria-hidden="true" />
          </div>
