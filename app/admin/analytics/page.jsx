...
export default function AdminAnalyticsPage() {
  ...
  return (
    <main id="main-content" className="flex flex-col bg-[#F8FAFC] min-h-screen text-slate-600 pb-20 overflow-x-hidden" aria-label="Admin analytics page">
      ...
      <section className="flex-1 p-5 md:p-8 max-w-[1180px] mx-auto w-full animate-in fade-in duration-1000 space-y-12" aria-label="Analytics content">
        <h1 className="sr-only">Company analytics dashboard</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 bg-white border-2 border-slate-50 rounded-[3rem] p-8 shadow-premium space-y-8">
            <div className="flex items-center justify-between pr-4">
              ...
              <Button onClick={() => setShowComparison(true)} variant="ghost" aria-label="Open department comparison dialog" className="rounded-2xl h-12 px-5 text-[10px] font-medium uppercase tracking-widest bg-slate-50 transition-all hover:bg-slate-100 active:scale-95">Compare Data</Button>
            </div>
            ...
            <div className="bg-white rounded-[3rem] shadow-mega w-full h-full overflow-hidden flex flex-col relative animate-in zoom-in-95 duration-500">
              <div className="p-8 border-b border-slate-50 flex justify-between items-center bg-slate-950 text-white">
                ...
                <Button
                  ...
                  aria-label="Close department comparison dialog"
