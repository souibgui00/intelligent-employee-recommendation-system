...
export class FaceRecognitionController {
    ...
    async registerFace(@Req() req: any, @UploadedFile() file: Express.Multer.File) {
        const user = req.user;
        console.log('[FaceRecognition] Registering face for user:', user?.sub, '| File size:', file?.size);
